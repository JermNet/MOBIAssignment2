    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (message) {
            ...
            case "secret color":
                ...
                break;
            default: // Color not found...just use cyan (because it's a better color)
                textView.setBackgroundColor(Color.CYAN);
        }

        // Add to the text
        textView.setText(message + "\n\nThe text colour has been changed, mwahahahaha!");
        ...
        // With this many frames skipped, the "Skipped # frames!" message is sent to the logcat. This is because the UI is rendering
        // slowly which forces the system to skip frames as counter balance. The postDelayed method seems to be a better alternative.
        try {
            Thread.sleep(2000);
